...
//手机加密分类图标
let classNameIconIphone = [require('./../../Image/极密盾加密/常用账户-橙.png'),
    require('./../../Image/极密盾加密/钱包-橙.png'),
    require('./../../Image/极密盾加密/金融理财-橙.png'),
    require('./../../Image/极密盾加密/身份证照-橙.png'),
    require('./../../Image/极密盾加密/合同发票-橙.png'),
    require('./../../Image/极密盾加密/联系人.png')];
let otherIconArrayIphone = [require('./../../Image/极密盾加密/密码页-橙.png'),require('./../../Image/极密盾加密/密条-橙.png')];
let classNameTitle = ['常用账户','钱包支付','金融理财','身份证照','合同发票','联系人'];
let otherTitle = ['密码页', '密条'];
let tagTitle = ['标签1', '标签2', '标签1', '标签2', '标签2'];

export default class CabBleView extends Component {
   constructor(props)
   {
     super(props);
 ...
 componentWillMount() {
            ...
            >
               ...
               <BtnView iconName={require('./../../Image/手机加密/DevListIcon.png')} BtnClickBackFunc={this.slideViewPressBackFunc.bind(this)} Touchstyle={[styles.headContainer, {left:10}]}/> 
                ...
                <BtnView iconName={require('./../../Image/手机加密/seachcopy.png')} BtnClickBackFunc={this.AddViewPressBackFunc.bind(this)} Touchstyle={[styles.headContainer, {left:Dimen.window.width-38-70}]}/>   
                    ...
                    <Text style={{fontSize:18,color: '#ab8f7d',textAlign:'center',width:200,left:(Dimen.window.width-200)*0.5}}>我的极密盾</Text>
                    <Text style={{ fontSize: 12, color: '#ab8f7d', textAlign: 'center', width: 200, left: (Dimen.window.width - 200) * 0.5, marginTop: 5 }}>(极密盾加密)</Text>
                    </View>    
    ...
    renderAllImage() {
        ...
        for (var i=0;i<this.props.CabPageNum;i++){
           ...
           allImage.push(
            <Image key={i} source={require('./../../Image/极密盾加密/Oval 4 Copy.png')} style={styles.roundType}/>   
            );
            }
            else
            { 
                allImage.push(
               <Image key={i} source={require('./../../Image/极密盾加密/Oval 4.png')} style={styles.roundType}/>
    ...
    //构建 Tag  Cell
      ...
      <View style={styles.CellType}>
              <Image source={require('./../../Image/极密盾加密/TagIcon.png')} style={{width:32,height:31,marginTop:15,marginLeft:ImageLeft}} />
              <Text style={{fontSize:14,color:'#666666',textAlign:'center',margin:5}}>{rowData}</Text>
              <Text style={{ fontSize: 10, color: '#999999', textAlign: 'center' }}>{ global.CabinetinterfaceREF.state.ClassDataNumArray[rowData] }条</Text>
     </View>
    </TouchableOpacity>        
